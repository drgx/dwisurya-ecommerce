...
class ControllerExtensionModuleIshiBannerBlock extends Controller {
	...
	public function index() {
		...
		foreach ($ishi_banners as $ishi_banner) {
			...
			$subtitlebgcolor = '';
			if (isset($this->request->post['subtitlebgcolor'])) {
				$subtitlebgcolor = $this->request->post['subtitlebgcolor'];
			} elseif (!empty($ishi_banner) && isset($ishi_banner['subtitlebgcolor'])) {
				$subtitlebgcolor = $ishi_banner['subtitlebgcolor'];
			}

			$buttoncolor = '';
			if (isset($this->request->post['buttoncolor'])) {
				$buttoncolor = $this->request->post['buttoncolor'];
			} elseif (!empty($ishi_banner) && isset($ishi_banner['buttoncolor'])) {
				$buttoncolor = $ishi_banner['buttoncolor'];
			}
